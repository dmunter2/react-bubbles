...
- [ ] Explain what a token is used for.
  a way for the server to know the user is allowed to access protected data and continue throughout the website without having to login

- [ ] What steps can you take in your web apps to keep your data secure?
  login page, and require token for api access


- [ ] Describe how web servers work.
  the browser asks for a url from a webserver then the webserver responds to that request
